...
if __name__ == '__main__':
    ...
    #importCase.impotTestCase("/Users/zoudw/PycharmProjects/automan/TestFile/ZhangJunChao/AssistantKeyword1.xlsx","assistantapp").kwReadExcel()
    #执行用例
    repName = str(datetime.now().strftime("%Y%m%d%H%M%S"))
    alluredir = "report/" + repName
    pytest.main(["-s", "testCase/tiaoshi", "-q", "--alluredir", alluredir])
    #生成可视化报告

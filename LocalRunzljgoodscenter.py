...
if __name__ == '__main__':
    ...
    #更新用例
    importCase.impotTestCase("/Users/zhanglijun/PycharmProjects/automan4/TestFile/zlj/ApiTestCasezljgoodscenter.xlsx","goodsCenter").readExcel()
    #执行用例
    repName = str(datetime.now().strftime("%Y%m%d%H%M%S"))
    alluredir = "report/" + repName
    pytest.main(["-s", "testCase/goodsCenter", "-q", "--alluredir", alluredir])
    #生成可视化报告

...
if __name__ == '__main__':
    ...
    importCase.impotTestCase("/Users/liangqi/PycharmProjects/automan/TestFile/LiangQi/financeBusinessKWTestCase.xlsx","financeBusiness").kwReadExcel()
    #执行用例
    repName = str(datetime.now().strftime("%Y%m%d%H%M%S"))
    alluredir = "report/" + repName
    pytest.main(["-s", "testCase/financeBusiness", "-q", "--alluredir", alluredir])
    #生成可视化报告

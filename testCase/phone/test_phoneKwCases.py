...
class Test_phone:
	...
	def test_lm_0029(self):
		...
		# 激活check接口
		bkw.thePublicApi_VProjectUserCheck({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"mobile":mobiles,"channel":channel},"env":envt},"dict")
		# 激活Detail接口
	...
	def test_lm_0032(self):
		...
		bkw.thePublicApi_VProjectUserDetail({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"channel":channel},"env":envt},"dict")
		# 激活NewActivate接口
		data1 = bkw.thePublicApi_VEquityNewActivate({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"channel":channel},"env":envt},"dict")
		# 首次打印提取的错误信息
		...
		jwt = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"jwt")
		# 激活check接口
		data = bkw.thePublicApi_VProjectUserCheck({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"mobile":mobiles,"channel":channel},"env":envt},"dict")
		# 打印提取的错误信息

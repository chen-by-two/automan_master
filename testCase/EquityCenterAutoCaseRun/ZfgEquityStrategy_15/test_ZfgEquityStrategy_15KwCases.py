...
class Test_ZfgEquityStrategy_15:

	@allure.feature("非合并分组-项目数量每月限制-面额卡领取失败场景-电子码领取方式")
	...
	def test_zfg_0001(self):
		...
		# 读取yaml文件内公众号登录账户
		mobiles = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"mobiles_15")
		...
		# 读取yaml文件权益项目ID
		projectId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"projectId_8")
		# 读取yaml文件权益分组ID
		groupId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"groupId_113")
		# 打印权益项目ID到日志
		...
		# 造公众号登录验证码
		ckw.CommonKeyWord().Db_ConfRedisSet("test_redis","verifyCode_valid_18523238199",LogintCaptchas)
		# 公众号登录
	...
	@allure.feature("非合并分组-项目数量每月限制-面额卡领取失败场景-雇主清单领取方式")
	@allure.severity("blocker")
	def test_zfg_0002(self):
		...
		projectId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"projectId_8")
		# 读取yaml文件权益分组ID
		groupId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"groupId_114")
		# 打印权益项目ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益项目ID:",projectId)
		# 打印权益分组ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益分组ID:",groupId)
	...
	@allure.feature("非合并分组-项目数量每月限制-面额卡领取失败场景-连接二维码-一码一权益领取方式")
	@allure.severity("blocker")
	def test_zfg_0003(self):
		...
		projectId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"projectId_8")
		# 读取yaml文件权益分组ID
		groupId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"groupId_115")
		# 打印权益项目ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益项目ID:",projectId)
		# 打印权益分组ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益分组ID:",groupId)
	...
	@allure.feature("非合并分组-项目数量每月限制-面额卡领取失败场景-连接二维码-通用码领取方式")
	@allure.severity("blocker")
	def test_zfg_0004(self):
		...
		projectId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"projectId_8")
		# 读取yaml文件权益分组ID
		groupId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"groupId_116")
		# 打印权益项目ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益项目ID:",projectId)
		# 打印权益分组ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益分组ID:",groupId)
		...
		ckw.CommonKeyWord().Print_ToLog("当前用户领取方式:",channel)
		# 获取当前权益信息
		bkw.thePublicApi_VProjectUserGroup({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":"Bearer "+token_2},"parma":{},"data":{"groupId":"3q09q1RPaTgGsAthe9lD10lX0M1Y","channel":channel},"env":envt},"dict")
		# 提交激活权益
		Rigres = bkw.thePublicApi_VEquityNewActivate({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":"Bearer "+token_2},"parma":{},"data":{"channel":channel},"env":envt},"dict")
		# 运营后台权益中心生成权益卡
		redeemadd = bkw.equityCenterApi_RedeemAdd({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":"Bearer "+Authorization},"parma":{},"data":{"cdKey":None,"userId":None,"name":None,"mobile":mobiles,"verifyName":None,"verifyMobile":mobiles,"verifyIdCard":None,"verifyKeyword1":None,"verifyKeyword2":None,"verifyKeyword3":None,"merchantId": "7","projectId": projectId,"groupId":groupId,"customerId":None,"nominalValue":30,"nominalTimes":None,"oneTimeValue":None,"idCardType":"01"},"env":envt},"dict")
		...
		ckw.CommonKeyWord().Print_ToLog("当前领取权益cdKey:",cdKey)
		# 领取权益信息提交
		vprojectusercheck = bkw.thePublicApi_VProjectUserGroup({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":"Bearer "+token_2},"parma":{},"data":{"groupId":"q09q1RPaTgGsAthe9lD10lX0M1Y","channel":channel},"env":envt},"dict")
		# 读取yaml文件权益达到领取限制断言
		ReceiveFailureAssertion = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"ReceiveFailureAssertion")
		# 打印领取权益接口出参到日志
		ckw.CommonKeyWord().Print_ToLog("当前领取接口出参:",vprojectusercheck)
	...
	@allure.feature("非合并分组-项目数量每月限制-面额卡领取失败场景-实物卡领取方式")
	@allure.severity("blocker")
	def test_zfg_0005(self):
		...
		projectId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"projectId_8")
		# 读取yaml文件权益分组ID
		groupId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"groupId_117")
		# 打印权益项目ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益项目ID:",projectId)
		# 打印权益分组ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益分组ID:",groupId)
	...
	@allure.feature("非合并分组-项目数量每月限制-面额卡领取失败场景-驻店宝-默认链接二维码领取方式")
	@allure.severity("blocker")
	def test_zfg_0006(self):
		...
		projectId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"projectId_8")
		# 读取yaml文件权益分组ID
		groupId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"groupId_118")
		# 打印权益项目ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益项目ID:",projectId)
		# 打印权益分组ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益分组ID:",groupId)
	...
	@allure.feature("非合并分组-项目数量每月限制-面额卡领取失败场景-驻店宝-指定手机号领取方式")
	@allure.severity("blocker")
	def test_zfg_0007(self):
		...
		projectId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"projectId_8")
		# 读取yaml文件权益分组ID
		groupId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"groupId_119")
		# 打印权益项目ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益项目ID:",projectId)
		# 打印权益分组ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益分组ID:",groupId)
	...
	@allure.feature("非合并分组-项目数量每月限制-面额卡领取失败场景-手机预分配领取方式")
	@allure.severity("blocker")
	def test_zfg_0008(self):
		...
		projectId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"projectId_8")
		# 读取yaml文件权益分组ID
		groupId = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"groupId_120")
		# 打印权益项目ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益项目ID:",projectId)
		# 打印权益分组ID到日志
		ckw.CommonKeyWord().Print_ToLog("当前权益分组ID:",groupId)

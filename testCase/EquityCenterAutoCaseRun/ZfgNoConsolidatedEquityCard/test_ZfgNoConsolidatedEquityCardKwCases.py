...
class Test_ZfgNoConsolidatedEquityCard:

	@allure.feature("权益中心-非合并面额卡领取激活-电子码领取方式-重复激活场景")
	@allure.severity("blocker")
	def test_zfg_0001(self):
		# 打开yaml文件
		yamlfile = ckw.CommonKeyWord().Yaml_Read("TestFile/FuGguang/ZfgNoConsolidatedEquityCard.yaml")
		# 读取yaml文件后台登录手机号
		...
		# 造公众号登录验证码
		ckw.CommonKeyWord().Db_ConfRedisSet("test_redis","verifyCode_valid_13714565208",LogintCaptchas_1)
		# 公众号登录
	...
	@allure.feature("权益中心-非合并面额卡领取激活-雇主清单领取方式-重复激活场景")
	@allure.severity("blocker")
	def test_zfg_0002(self):
		...
		ckw.CommonKeyWord().Print_ToLog("当前权益分组ID：",groupId_1)
		# 权益中心生成权益卡
		redeemadd = bkw.equityCenterApi_RedeemAdd({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":"Bearer "+Authorization_1},"parma":{},"data":{"cdKey":None,"userId":None,"name":"陈思佳","mobile":mobiles,"verifyName":"陈思佳","verifyMobile":mobiles,"verifyIdCard":"110101199003075613","verifyKeyword1":None,"verifyKeyword2":None,"verifyKeyword3":None,"merchantId": "7","projectId": projectId_1,"groupId":groupId_1,"customerId":None,"nominalValue":20,"nominalTimes":None,"oneTimeValue":None,"idCardType":"1"},"env":envt},"dict")
		# 提取权益中心权益电子兑换码
		cdkey = ckw.CommonKeyWord().Json_GetJsonValue(redeemadd,[["data","verify","cdKey"]])
		# 打印提取权益中心权益电子兑换码到日志
		ckw.CommonKeyWord().Print_ToLog("电子权益兑换码：",cdkey)
	...
	@allure.feature("权益中心-非合并面额卡领取激活-链接二维码领取-一码一权益-重复激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取激活-链接二维码领取-通用码-重复激活场景")
	@allure.severity("blocker")
	def test_zfg_0004(self):
		...
		ckw.CommonKeyWord().Print_ToLog("当前领取方式：",channel)
		# 获取当前权益信息
		bkw.thePublicApi_VProjectUserGroup({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":"Bearer "+token_2},"parma":{},"data":{"groupId":"khVflxK1kr8k0Pku3MGo4kgyGRw","channel":channel},"env":envt},"dict")
		# 提交激活权益
		Rigres = bkw.thePublicApi_VEquityNewActivate({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":"Bearer "+token_2},"parma":{},"data":{"channel":channel,"sourceType":"wx"},"env":envt},"dict")
		# 重复提交激活
		Risres = bkw.thePublicApi_VEquityNewActivate({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":"Bearer "+token_2},"parma":{},"data":{"channel":channel,"sourceType":"wx"},"env":envt},"dict")
	...
	@allure.feature("权益中心-非合并面额卡领取激活-实物卡领取-重复激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取机会-手机预分配-重复激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取激活-驻店宝指定手机号领取激活-重复激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取激活-驻店宝指定链接二维码领取激活-重复激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取激活-电子码领取方式-正常激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取激活-雇主清单领取方式-正常激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取激活-链接二维码领取-一码一权益-正常激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取激活-链接二维码领取-通用码-正常激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取激活-实物卡领取-正常激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取机会-手机预分配-正常激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取激活-驻店宝指定手机号领取激活-正常激活场景")
	@allure.severity("blocker")
	...
	@allure.feature("权益中心-非合并面额卡领取激活-驻店宝指定链接二维码领取激活-正常激活场景")
	@allure.severity("blocker")

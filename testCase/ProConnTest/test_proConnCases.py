...
class Test_ProConnTest:

	@allure.feature("ProConnTest")
	...
	def test_UnifyorderConfirmCreate_testConn(self):
		...
		UnifyorderConfirmCreate.changeEnv("uniondrug.cn")
	...
	def test_UnifyorderConfirmInvoiceChange_testConn(self):
		...
		UnifyorderConfirmInvoiceChange.changeEnv("uniondrug.cn")
	...
	def test_UnifyorderOrderCreate_testConn(self):
		...
		UnifyorderOrderCreate.changeEnv("uniondrug.cn")
	...
	def test_UnifyorderCashierPayModes_testConn(self):
		...
		UnifyorderCashierPayModes.changeEnv("uniondrug.cn")
	...
	def test_UnifyorderOrderDetail_testConn(self):
		...
		UnifyorderOrderDetail.changeEnv("uniondrug.cn")
	...
	def test_UnifyorderCashierCheck_testConn(self):
		...
		UnifyorderCashierCheck.changeEnv("uniondrug.cn")
	...
	def test_AdvisorListRecommendAdv_testConn(self):
		...
		AdvisorListRecommendAdv.changeEnv("uniondrug.cn")
	...
	def test_WordSuggesterSuggester_testConn(self):
		...
		WordSuggesterSuggester.changeEnv("uniondrug.cn")
	...
	def test_GoodsSearchSearchGoodsAll_testConn(self):
		...
		GoodsSearchSearchGoodsAll.changeEnv("uniondrug.cn")
	...
	def test_GoodsSearchSearchGoodsByTradeCode_testConn(self):
		...
		GoodsSearchSearchGoodsByTradeCode.changeEnv("uniondrug.cn")
	...
	def test_GoodsSearchSearchGoodsGeo_testConn(self):
		...
		GoodsSearchSearchGoodsGeo.changeEnv("uniondrug.cn")
	...
	def test_OtoManageSearch_testConn(self):
		...
		OtoManageSearch.changeEnv("uniondrug.cn")
	...
	def test_GoodsSearchCorrectSearchContent_testConn(self):
		...
		GoodsSearchCorrectSearchContent.changeEnv("uniondrug.cn")
	...
	def test_QueryGoodsQueryGoodsBaseInfo_testConn(self):
		...
		QueryGoodsQueryGoodsBaseInfo.changeEnv("uniondrug.cn")
	...
	def test_SkuQuery_testConn(self):
		...
		SkuQuery.changeEnv("uniondrug.cn")
	...
	def test_SkuSimple_testConn(self):
		...
		SkuSimple.changeEnv("uniondrug.cn")
	...
	def test_GoodsSearchSearchUnify_testConn(self):
		...
		GoodsSearchSearchUnify.changeEnv("uniondrug.cn")
	...
	def test_GoodsSearchSearch_testConn(self):
		...
		GoodsSearchSearch.changeEnv("uniondrug.cn")
	...
	def test_UserPackageBaseCreate_testConn(self):
		...
		UserPackageBaseCreate.changeEnv("uniondrug.cn")
	...
	def test_UserPackageHighlevelCreate_testConn(self):
		...
		UserPackageHighlevelCreate.changeEnv("uniondrug.cn")
	...
	def test_UserPackageUsersGet_testConn(self):
		...
		UserPackageUsersGet.changeEnv("uniondrug.cn")
	...
	def test_MemberWideInsertMemberPackage_testConn(self):
		...
		MemberWideInsertMemberPackage.changeEnv("uniondrug.cn")
	...
	def test_OrderWideInsertOrderPackage_testConn(self):
		...
		OrderWideInsertOrderPackage.changeEnv("uniondrug.cn")
	...
	def test_UserPackageDelete_testConn(self):
		...
		UserPackageDelete.changeEnv("uniondrug.cn")
	...
	def test_UserPackageListMember_testConn(self):
		...
		UserPackageListMember.changeEnv("uniondrug.cn")

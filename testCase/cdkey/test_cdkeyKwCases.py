...
class Test_cdkey:
	...
	@allure.feature("权益中心-合并面额卡激活（电子码）无限制成功")
	@allure.severity("blocker")
	def test_lm_0001(self):
		# 打开yaml文件
		yamlfile = ckw.CommonKeyWord().Yaml_Read("D:/test11111111111111111111/automan/TestFile/lm/lm1.yaml")
		# 读取yaml文件权益项目ID
		...
		# 激活check接口
		bkw.thePublicApi_VProjectUserCheck({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"cdKey": cdkey,"channel":channel},"env":envt},"dict")
		# 激活Detail接口
		bkw.thePublicApi_VProjectUserDetail({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"channel":channel},"env":envt},"dict")
		# 激活NewActivate接口
		data = bkw.thePublicApi_VEquityNewActivate({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"channel":channel},"env":envt},"dict")
		# 提取激活成功错误码errno
	...
	def test_lm_0002(self):
		...
		data = bkw.thePublicApi_VEquityNewActivate({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"channel":channel},"env":envt},"dict")
		# 重复提交激活
		erroData = bkw.thePublicApi_VEquityNewActivate({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"channel":channel},"env":envt},"dict")
		# 打印提取的错误信息
	...
	def test_lm_0004(self):
		...
		jwt = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"jwt")
		# 激活check接口
		data = bkw.thePublicApi_VProjectUserCheck({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"cdKey": cdkey1,"channel":channel},"env":envt},"dict")
		# 打印提取的错误信息
		ckw.CommonKeyWord().Print_ToControl("提取的错误信息：",data)
		# 读取单日数量上限激活断言
	...
	def test_lm_0010(self):
		...
		jwt = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"jwt")
		# 激活check接口
		data = bkw.thePublicApi_VProjectUserCheck({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"cdKey": cdkey,"channel":channel},"env":envt},"dict")
		# 打印提取的错误信息
		ckw.CommonKeyWord().Print_ToControl("提取的错误信息：",data)
		# 读取单月数量上限激活断言
		limitErrono = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"limitErrono")
	...
	def test_lm_0020(self):
		...
		jwt = ckw.CommonKeyWord().Yaml_GetByKey(yamlfile,"jwt")
		# 激活check接口
		errolimit = bkw.thePublicApi_VProjectUserCheck({"header":{"Content-Type": "application/json;charsetUTF-8","Authorization":jwt},"parma":{},"data":{"cdKey": cdkey1,"channel":channel},"env":envt},"dict")
		# 打印提取的错误信息

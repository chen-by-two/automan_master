...
class Test_RcConnTest:

	@allure.feature("RcConnTest")
	...
	def test_UnifyorderConfirmCreate_testConn(self):
		...
		UnifyorderConfirmCreate.changeEnv("uniondrug.net")
	...
	def test_UnifyorderConfirmInvoiceChange_testConn(self):
		...
		UnifyorderConfirmInvoiceChange.changeEnv("uniondrug.net")
	...
	def test_UnifyorderOrderCreate_testConn(self):
		...
		UnifyorderOrderCreate.changeEnv("uniondrug.net")
	...
	def test_UnifyorderCashierPayModes_testConn(self):
		...
		UnifyorderCashierPayModes.changeEnv("uniondrug.net")
	...
	def test_UnifyorderOrderDetail_testConn(self):
		...
		UnifyorderOrderDetail.changeEnv("uniondrug.net")
	...
	def test_UnifyorderCashierCheck_testConn(self):
		...
		UnifyorderCashierCheck.changeEnv("uniondrug.net")
	...
	def test_AdvisorListRecommendAdv_testConn(self):
		...
		AdvisorListRecommendAdv.changeEnv("uniondrug.net")
	...
	def test_WordSuggesterSuggester_testConn(self):
		...
		WordSuggesterSuggester.changeEnv("uniondrug.net")
	...
	def test_GoodsSearchSearchGoodsAll_testConn(self):
		...
		GoodsSearchSearchGoodsAll.changeEnv("uniondrug.net")
	...
	def test_GoodsSearchSearchGoodsByTradeCode_testConn(self):
		...
		GoodsSearchSearchGoodsByTradeCode.changeEnv("uniondrug.net")
	...
	def test_GoodsSearchSearchGoodsGeo_testConn(self):
		...
		GoodsSearchSearchGoodsGeo.changeEnv("uniondrug.net")
	...
	def test_OtoManageSearch_testConn(self):
		...
		OtoManageSearch.changeEnv("uniondrug.net")
	...
	def test_GoodsSearchCorrectSearchContent_testConn(self):
		...
		GoodsSearchCorrectSearchContent.changeEnv("uniondrug.net")
	...
	def test_QueryGoodsQueryGoodsBaseInfo_testConn(self):
		...
		QueryGoodsQueryGoodsBaseInfo.changeEnv("uniondrug.net")
	...
	def test_SkuQuery_testConn(self):
		...
		SkuQuery.changeEnv("uniondrug.net")
	...
	def test_SkuSimple_testConn(self):
		...
		SkuSimple.changeEnv("uniondrug.net")
	...
	def test_GoodsSearchSearchUnify_testConn(self):
		...
		GoodsSearchSearchUnify.changeEnv("uniondrug.net")
	...
	def test_GoodsSearchSearch_testConn(self):
		...
		GoodsSearchSearch.changeEnv("uniondrug.net")
	...
	def test_UserPackageBaseCreate_testConn(self):
		...
		UserPackageBaseCreate.changeEnv("uniondrug.net")
	...
	def test_UserPackageHighlevelCreate_testConn(self):
		...
		UserPackageHighlevelCreate.changeEnv("uniondrug.net")
	...
	def test_UserPackageUsersGet_testConn(self):
		...
		UserPackageUsersGet.changeEnv("uniondrug.net")
	...
	def test_MemberWideInsertMemberPackage_testConn(self):
		...
		MemberWideInsertMemberPackage.changeEnv("uniondrug.net")
	...
	def test_OrderWideInsertOrderPackage_testConn(self):
		...
		OrderWideInsertOrderPackage.changeEnv("uniondrug.net")
	...
	def test_UserPackageDelete_testConn(self):
		...
		UserPackageDelete.changeEnv("uniondrug.net")
	...
	def test_UserPackageListMember_testConn(self):
		...
		UserPackageListMember.changeEnv("uniondrug.net")
